...
class RefundRequestSheet extends StatefulWidget {
  ...
  final GetOrderRefundEligibility getOrderRefundEligibility;
  ...
  const RefundRequestSheet({
    super.key,
    required this.order,
    required this.getOrderRefundEligibility,
  ...
  Future<void> _load() async {
    ...
    try {
      final results = await Future.wait<dynamic>([
        widget.getOrderRefundEligibility(widget.order.id),
        widget.getMyBankAccounts(),
        widget.getBanks(),
      ]);
        ...
        .push<UserBankAccountResponse>(
          MaterialPageRoute(
            builder: (_) => BankAccountFormPage(
              ...
              updateBankAccount: widget.updateBankAccount,
              banks: banks,
            ),
          ),
        );
