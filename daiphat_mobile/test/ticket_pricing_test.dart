...
void main() {
  group('Pricing SSOT Contract Tests', () {
    ...
    test('LotteryTicket.effectivePrice returns 10,000 when priceSnapshot is null or 0', () {
    ...
    test('LotteryTicket.effectivePrice returns custom price when priceSnapshot > 0', () {
    ...
    test('LotteryTicketListItem.effectivePrice returns 10,000 fallback when price is null or 0', () {
    ...
    test('mapLotteryTicketToListItem preserves effectivePrice from LotteryTicket', () {
    ...
    test('LotteryTicket.fromJson parses price and unitPrice when priceSnapshot is omitted', () {
