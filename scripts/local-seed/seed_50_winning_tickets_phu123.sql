...
-- 50 winning tickets for phu123 (phujason1992@gmail.com) across the last 5 past VN draw days.
-- Creates member user if missing (default password: Phu123456).
-- 11 prize tiers, each >= 3 winners; 30 tickets PROXY_HOLDING (online claim), 20 HANDED_OVER (large prizes).
-- 12 COMPLETED online orders with varied ticket counts (2–6 per order).
-- Requires: stations, prize_structures, supplier MINHCHINH/MINH_CHINH (V202608181500).
-- Version renumbered from V202608181700 to avoid clash with align_jpa_column_drift.
