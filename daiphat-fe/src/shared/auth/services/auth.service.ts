...
const normalizeAuthResponse = <T extends ApiResponse<unknown>>(response: T): T => {
...
export const authService = {
    ...
    getMe: async (accessToken?: string): Promise<GetMeResponse> => {
        ...
        const user = (response.data?.data || response.data) as Record<string, unknown> | undefined;
