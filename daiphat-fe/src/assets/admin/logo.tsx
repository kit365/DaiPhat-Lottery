import { CLIENT_LOGO } from '@/client/constants/clientBannerAssets';
    ...
    return (
        <div className={`flex items-center gap-3 ${className || ''}`}>
            <div className="relative p-[2px] bg-gradient-to-tr from-[#ee1314] to-[#F59E0B] rounded-xl shadow-md shadow-[#ee1314]/10 shrink-0 w-[40px] h-[40px] flex items-center justify-center">
                <img 
                    src={CLIENT_LOGO || "https://i.ibb.co/YBYnq3HR/z7824247008533-94446d3b6c16598cda67404d805c15c4-removebg-preview.png"} 
                    alt="Đại Phát Logo"
