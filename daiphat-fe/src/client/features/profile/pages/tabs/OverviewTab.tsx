            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white rounded-xl shadow-[0_2px_12px_rgb(0,0,0,0.03)] border border-[#E5E8EB] p-5">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <Link href={ROUTES.PUBLIC.PROFILE.ORDERS} className="text-[13px] text-[#637381] hover:text-[#ee1314]">Xem tất cả &gt;</Link>
                    </div>
                ...
                <div className="bg-white rounded-xl shadow-[0_2px_12px_rgb(0,0,0,0.03)] border border-[#E5E8EB] p-5">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
                        <Link href={ROUTES.PUBLIC.TICKETS} className="flex flex-col items-center justify-center gap-2 p-3 rounded-xl border border-[#E5E8EB] hover:border-[#ee1314] hover:shadow-sm transition-all group">
                        ...
                        <Link href={ROUTES.PUBLIC.PROFILE.MY_TICKETS} className="flex flex-col items-center justify-center gap-2 p-3 rounded-xl border border-[#E5E8EB] hover:border-[#FFB020] hover:shadow-sm transition-all group">
                        ...
                        <Link href={ROUTES.PUBLIC.HOME} className="flex flex-col items-center justify-center gap-2 p-3 rounded-xl border border-[#E5E8EB] hover:border-[#1CD162] hover:shadow-sm transition-all group">
                        ...
                        <Link href={ROUTES.PUBLIC.SCHEDULE} className="flex flex-col items-center justify-center gap-2 p-3 rounded-xl border border-[#E5E8EB] hover:border-[#2065D1] hover:shadow-sm transition-all group">
                        ...
                        <Link href={ROUTES.PUBLIC.TICKETS} className="flex flex-col items-center justify-center gap-2 p-3 rounded-xl border border-[#E5E8EB] hover:border-[#FF4842] hover:shadow-sm transition-all group">
                        ...
                        <Link href={ROUTES.PUBLIC.PROFILE.COMPLAINTS} className="flex flex-col items-center justify-center gap-2 p-3 rounded-xl border border-[#E5E8EB] hover:border-[#9E5FFF] hover:shadow-sm transition-all group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-[0_2px_12px_rgb(0,0,0,0.03)] border border-[#E5E8EB] p-5">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <Link href={ROUTES.PUBLIC.PROFILE.MY_TICKETS} className="text-[13px] text-[#637381] hover:text-[#ee1314]">Xem tất cả &gt;</Link>
                    </div>
