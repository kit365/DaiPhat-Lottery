        ...
        try {
            ...
            if (response.code === "success") {
                ...
                if (paymentMethod === "zalopay") {
                    window.location.href = `http://localhost:8080/client/order/payment-zalopay?orderCode=${response.orderCode}&phone=${response.phone}`;
                } else if (paymentMethod === "vnpay") {
                    window.location.href = `http://localhost:8080/client/order/payment-vnpay?orderCode=${response.orderCode}&phone=${response.phone}`;
                } else {
