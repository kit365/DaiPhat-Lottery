  ...
  return (
    <div className="bg-white rounded-[32px] p-6 shadow-[0_15px_40px_rgba(0,0,0,0.03)] border border-gray-100 font-client-main relative overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-8 relative z-10">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-[#FCE5DF] flex items-center justify-center">
            <span className="material-symbols-outlined text-[#ee1314] text-[18px]">history</span>
          </div>
        ...
        <button
          className="group text-[12px] font-bold text-slate-400 hover:text-[#ee1314] flex items-center gap-0.5 cursor-pointer transition-all font-client-main"
        >
          Xem tất cả
        ...
        {history.slice(0, 5).map((item, idx) => (
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <div className="w-11 h-11 rounded-2xl bg-white shadow-sm border border-slate-100 flex items-center justify-center text-slate-400 group-hover:bg-[#ee1314] group-hover:text-white group-hover:border-transparent transition-all duration-300">
                <span className="material-symbols-outlined text-[22px]">confirmation_number</span>
              </div>
              <div className="flex flex-col">
                <span className="text-[13px] font-black text-[#102937] leading-tight mb-0.5 group-hover:text-[#ee1314] transition-colors">{item.date}</span>
            ...
            <div className="flex flex-col items-end">
              <span className="text-[18px] font-black text-[#ee1314] font-client-display tracking-widest group-hover:scale-110 transition-transform origin-right">
                {item.prizes.special}
              </span>
      ...
      <div className="mt-6 pt-4 border-t border-slate-50 text-center">
        <button className="text-[11px] font-black text-slate-300 hover:text-[#ee1314] uppercase tracking-widest transition-colors cursor-pointer">
