        ...
        <table className="w-full border-collapse table-fixed">
          <thead>
            <tr className="bg-slate-50 border-b border-gray-100">
              ...
              <th className="py-2.5 px-1 text-[11px] font-bold text-[#ee1314] uppercase border-r border-gray-100 w-[20%] text-center font-client-main">Số</th>
            ...
            {lotoData.map((row) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className={`text-[#ee1314] text-[17px] font-bold leading-none font-client-main transition-colors inline-flex items-center justify-center min-w-[24px] h-[24px] rounded-md ${isActive ? 'bg-white shadow-sm' : ''}`}>
                      {row.head}
                    </span>
                  </td>
