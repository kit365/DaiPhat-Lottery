          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div className="space-y-1.5">
              <div className="flex items-center gap-2.5">
                <div className="w-[4px] h-5 bg-[#ee1314]"></div>
              ...
              <div className="flex items-center gap-2 ml-3.5">
                <p className="text-slate-600 text-[14px] flex items-center gap-2">
                  <span className="flex gap-1 items-center">
                    <span className="w-2 h-2 rounded-full bg-[#ee1314] animate-pulse"></span>
                  </span>
                  <span>
                    ...
                    Còn <span className="text-[#ee1314] font-semibold tabular-nums ml-1">{formatTime(timeLeft.h)}:{formatTime(timeLeft.m)}:{formatTime(timeLeft.s)}</span> nữa
                  </span>
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center gap-6 whitespace-nowrap w-full">
            ...
            <div className="flex items-center gap-4 pr-6 border-r border-slate-200">
              <button
                ...
                className={`text-[12px] font-bold transition-all font-client-display uppercase tracking-tight cursor-pointer ${displayType === 'full' ? 'text-[#ee1314]' : 'text-slate-500 hover:text-[#102937]'}`}
              >
                Đầy đủ
              </button>
              ...
              <button
                ...
                className={`text-[12px] font-bold transition-all font-client-display uppercase tracking-tight cursor-pointer ${displayType === '2-digit' ? 'text-[#ee1314]' : 'text-slate-500 hover:text-[#102937]'}`}
              >
                2 số
              </button>
              <div className="w-[1px] h-3 bg-gray-300/50"></div>
              <button
                ...
                className={`text-[12px] font-bold transition-all font-client-display uppercase tracking-tight cursor-pointer ${displayType === '3-digit' ? 'text-[#ee1314]' : 'text-slate-500 hover:text-[#102937]'}`}
              >
                3 số
              </button>
            </div>
            ...
            <button
              ...
              className={`flex font-bold text-[12px] items-center gap-2 transition-all font-client-main uppercase tracking-tight ml-auto cursor-pointer ${showLoto ? 'text-[#ee1314]' : 'text-slate-500 hover:text-[#ee1314]'}`}
            >
        ...
        <div className="w-full">
          ...
          <div className="flex border-b border-gray-100 bg-[#FCE5DF]/30">
            ...
            <div className="flex-1 flex items-center justify-center py-6">
              <span className="text-[#ee1314] text-3xl lg:text-4xl font-black tracking-tight">
