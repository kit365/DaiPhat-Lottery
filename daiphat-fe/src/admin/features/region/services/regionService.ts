...
import { LotteryRegionResponse, UpdateLotteryRegionRequest } from '../types/region.type';
...
export const updateRegion = async (
    code: string,
    data: UpdateLotteryRegionRequest
): Promise<ApiResponse<LotteryRegionResponse>> => {
