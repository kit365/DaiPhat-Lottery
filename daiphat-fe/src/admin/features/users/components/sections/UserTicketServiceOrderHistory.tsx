...
interface UserTicketServiceOrderHistoryProps {
    userId: string;
}

export const UserTicketServiceOrderHistory = ({ userId }: UserTicketServiceOrderHistoryProps) => {
                        ...
                        >
                            ...
                            <Box>
                                ...
                                <Typography variant="caption" sx={{ color: 'var(--palette-text-disabled)' }}>
                                    Vé người dùng: {ticketServiceOrder.userTicketIds?.map((p: any) => p.name).join(', ') || "N/A"}
                                </Typography>
                            </Box>
                            <Box>
