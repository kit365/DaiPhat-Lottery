...
import { useUsers, useCreateUser, useUpdateUser, useDeleteUser, useUserDetail, useUserStatuses, useSearchCustomers, useRoles, useStaffByTicketService, useUploadUserAvatar, useDeleteUserAvatar, useChangeUserPassword } from "../../hooks/useUsers";
...
export const AccountAdminQuickUpdateModal = ({ open, onClose, id }: AccountAdminQuickUpdateModalProps) => {
    const { data: account, isLoading } = useUserDetail(id || undefined);
