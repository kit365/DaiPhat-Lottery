...
const registerPriorityChunkLoaders = () => {
    const loaders: Array<[string, () => Promise<unknown>]> = [
        ...
        [ROUTES.ADMIN.DASHBOARD.SETTINGS.ROOT, () => import('@/admin/pages/settings/SettingsPage')],
        [ROUTES.ADMIN.DASHBOARD.SETTINGS.GENERAL, () => import('@/admin/pages/settings/SettingsPage')],
        [ROUTES.ADMIN.DASHBOARD.SETTINGS.POLICIES, () => import('@/admin/pages/settings/SettingsPage')],
        [ROUTES.ADMIN.DASHBOARD.SETTINGS.PAGES, () => import('@/admin/pages/settings/SettingsPage')],
        [ROUTES.ADMIN.DASHBOARD.SETTINGS.APP_PASSWORD, () => import('@/admin/pages/settings/SettingsPage')],
