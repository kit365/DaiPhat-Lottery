...
export const DraftIcon = (props: SvgIconProps) => (
    ...
    >
        ...
        <path fill="currentColor" d="m19.352 7.617l-3.96-3.563c-1.127-1.015-1.69-1.523-2.383-1.788L13 5c0 2.357 0 3.536.732 4.268S15.643 10 18 10h3.58c-.362-.704-1.012-1.288-2.228-2.383"></path>
    </SvgIcon>
);
