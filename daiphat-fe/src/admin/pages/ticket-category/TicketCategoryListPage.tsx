        ...
        <>
            <div className="mb-[calc(5*var(--spacing))] gap-[calc(2*var(--spacing))] flex items-start justify-end">
                <div className="mr-auto">
                    <Title title={isTrash ? "Thùng rác Miền/Tỉnh thành" : "Danh sách Miền/Tỉnh thành"} />
                    <Breadcrumb
                        items={[
                            { label: "Dashboard", to: "/" },
                ...
                <div style={{ display: 'flex', gap: '16px' }}>
                    ...
                    <Button
                        onClick={() => navigate(`/${prefixAdmin}/ticket-category/create`)}
                        sx={{
            ...
            <TicketCategoryList isTrash={isTrash} />
        </>
    )
}
