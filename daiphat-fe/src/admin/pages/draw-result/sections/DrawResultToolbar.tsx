import { Toolbar, Box, FormControl, InputLabel, MenuItem, Select, TextField, Chip, Button, Badge, SvgIcon, Popover, IconButton, Typography, Divider, List, ListItem, ListItemButton, ListItemText, Radio, InputAdornment } from "@mui/material";
...
export const DrawResultToolbar = ({
    ...
    if (dateMode !== 'single') filterCount++;
