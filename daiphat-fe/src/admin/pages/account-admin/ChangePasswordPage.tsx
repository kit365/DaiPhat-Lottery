...
import { useAccountDetail, useConfirmAccountPasswordReset, useInitiateAccountPasswordReset } from "./hooks/useAccountAdmin";
...
export const ChangePasswordPage = () => {
    ...
    const { mutate: initiateReset, isPending: isInitiating } = useInitiateAccountPasswordReset();
    const { mutate: confirmReset, isPending: isConfirming } = useConfirmAccountPasswordReset();
