                        ...
                        >
                            <Stack p="calc(3 * var(--spacing))" gap="calc(3 * var(--spacing))">
                                <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "1fr 1fr" }, gap: "32px" }}>
                                    ...
                                    <Box>
                                        <Box sx={{ mb: 3 }}>
                                            <Typography sx={{ fontSize: '0.875rem', fontWeight: 600, mb: 1 }}>{t("admin.role.type")}</Typography>
                                            <Controller
                                                name="isStaff"
                                                control={control}
                                                render={({ field }) => (
                                                    <FormControlLabel
                                                        ...
                                                        label={<Typography sx={{ fontSize: '0.875rem' }}>{t("admin.role.is_staff")}</Typography>}
                                                    />
                                                )}
                                            />
                                        </Box>
                                        ...
                                        {isStaff && (
                                            <Box>
                                                <Typography sx={{ fontSize: '0.875rem', fontWeight: 600, mb: 1 }}>{t("admin.role.skills")}</Typography>
                                                <Controller
                                                    name="serviceIds"
                                                    control={control}
                                                    render={({ field }) => (
