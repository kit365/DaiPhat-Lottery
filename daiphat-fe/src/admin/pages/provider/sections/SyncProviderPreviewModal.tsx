...
import { useConfirmSyncProviders } from '../hooks/useProvider';
...
interface SyncProviderPreviewModalProps {
    open: boolean;
    onClose: () => void;
    previewData: any;
...
export const SyncProviderPreviewModal: React.FC<SyncProviderPreviewModalProps> = ({
    open,
    onClose,
    previewData,
    syncParams,
}) => {
    const { mutate: confirmSync, isPending } = useConfirmSyncProviders();
