        ...
        createTicketServiceOrder(data, {
            onSuccess: (res: any) => {
                ...
                if (formData.paymentMethod === "zalopay" && formData.paymentStatus === "unpaid") {
                    window.location.href = `http://localhost:8080/client/order/payment-zalopay?ticketServiceOrderCode=${ticketServiceOrder.code}&phone=${phone}`;
                } else if (formData.paymentMethod === "vnpay" && formData.paymentStatus === "unpaid") {
                    window.location.href = `http://localhost:8080/client/order/payment-vnpay?ticketServiceOrderCode=${ticketServiceOrder.code}&phone=${phone}`;
                } else {
