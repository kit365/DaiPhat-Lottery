...
import { useCreateTicketService } from "./hooks/useTicketService";
...
export const TicketServiceCreatePage = () => {
    ...
    const { mutate: create, isPending } = useCreateTicketService();
    ...
    const onSubmit = (data: TicketServiceFormValues) => {
        console.log("Creating ticketService data:", data);
        create(data, {
            onSuccess: (response) => {
                                ...
                                {pricingType === 'fixed' ? (
                                    ...
                                    <Box>
                                        ...
                                        <Table>
                                            <TableHead>
                                                <TableRow>
                                                    <TableCell sx={{ fontSize: '0.8125rem', width: 250 }}>Số lượng (vé)</TableCell>
