...
const WelcomeWidget = ({ title, description, img, bgImg, action }: WelcomeWidgetProps) => {
    return (
        <Box
            sx={{
        ...
        >
            ...
            {/* Decorative SVG Pattern from original code */}
            <Box
                component="svg"
                viewBox="0 0 480 360"
