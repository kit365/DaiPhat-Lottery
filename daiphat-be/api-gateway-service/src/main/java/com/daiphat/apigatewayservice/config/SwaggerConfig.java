...
public class SwaggerConfig {
    ...
    @Value("${daiphat.auth.keycloak.auth-server-url:http://localhost:8180}")
    private String authServerUrl;

    @Value("${daiphat.auth.keycloak.realm:daiphat}")
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("DaiPhat API Gateway")
                        .version("1.0.0")
                        .description("Tài liệu API tổng hợp cho hệ thống DaiPhat")
