...
/**
 * Test-only shim for message constants previously living in main sources.
 * Values mirror src/main/resources/chat/chat-messages.yml.
 */
public final class ChatAiMessages {
    ...
    public static final String NOT_UNDERSTOOD =
            "Xin lỗi, mình chưa hiểu rõ yêu cầu. Bạn có thể hỏi về lịch quay, kết quả xổ số hoặc đơn hàng. Nếu cần gặp nhân viên, bấm \"Trò chuyện với nhân viên hỗ trợ\" bên dưới.";

    private ChatAiMessages() {
    }
}
