...
import com.daiphat.coreapi.application.constant.chat.intent.ChatWebAccountMessages;
import com.daiphat.coreapi.application.strategy.chat.intent.WebAccountIntentStrategy;
...
@DisplayName("WebAccountIntentStrategy")
class WebAccountIntentHandlerTest {
    ...
    void resolve_whenLookupFailed_returnsLookupFailedMessage() {
        ...
        when(orderServicePort.getMyOrders(
                ...
                ChatWebAccountMessages.ORDER_LOOKUP_DIRECTION,
                conversation.getCustomerId()
        )).thenThrow(new DomainException(ErrorCode.INTERNAL_SERVER_ERROR, "Database error"));
