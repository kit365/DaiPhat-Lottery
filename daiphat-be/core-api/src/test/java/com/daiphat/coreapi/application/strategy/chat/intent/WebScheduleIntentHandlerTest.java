...
import com.daiphat.coreapi.application.strategy.chat.intent.handler.WebScheduleIntentHandler;
...
@DisplayName("WebScheduleIntentHandler")
class WebScheduleIntentHandlerTest {

    @Mock
    private DrawScheduleFlowService drawScheduleFlowService;

    private WebScheduleIntentHandler handler;

    @BeforeEach
    void setUp() {
        handler = new WebScheduleIntentHandler(drawScheduleFlowService);
    }
