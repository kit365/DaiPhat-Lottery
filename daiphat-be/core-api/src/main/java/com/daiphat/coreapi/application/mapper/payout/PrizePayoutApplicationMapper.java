...
public class PrizePayoutApplicationMapper {
    ...
    public PrizePayoutRequestResponse toResponse(
        ...
        return new PrizePayoutRequestResponse(
                ...
                model.getRecipientSelfieUrl(),
                model.getEkycStatus() != null ? model.getEkycStatus().name() : null,
                model.getEkycFaceDistance(),
                model.getEkycLivenessScore(),
                model.getEkycFailureReason(),
                model.getEkycOcrName(),
                model.getEkycOcrIdNumber(),
                model.getEkycOcrDob(),
                model.getEkycOcrGender(),
                model.getEkycOcrNationality(),
                model.getEkycOcrPlaceOfBirth(),
                model.getEkycOcrPlaceOfResidence(),
                model.getEkycOcrIssueDate(),
                model.getEkycOcrExpiryDate(),
                model.getEkycVerifiedAt(),
