package com.daiphat.coreapi.infrastructure.adapter.out.lotteries.prizestructure.source.strategy.xosovn;
...
import com.daiphat.coreapi.infrastructure.adapter.out.lotteries.prizestructure.source.strategy.PrizeStructureSourceStrategy;
...
public class XosoVnPrizeStructureSourceStrategy implements PrizeStructureSourceStrategy {
    ...
    public List<String> sourceUrls(String region) {
        ...
        return List.of(DIFFERENCE_ARTICLE_URL);
    }
    ...
    public List<PrizeStructureSourceItem> extractItems(Map<String, Document> documents, String region) {
        ...
        return switch (LotteryRegionCode.valueOf(normalized)) {
            case MIEN_TRUNG, MIEN_NAM -> southernPrizeStructureParser.parse(normalized);
