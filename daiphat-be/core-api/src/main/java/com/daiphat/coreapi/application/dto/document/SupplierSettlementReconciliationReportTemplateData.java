...
public record SupplierSettlementReconciliationReportTemplateData(
        ...
        boolean paid,
        List<String> paymentEvidenceImages,
        String unitPriceAfterCommission,
        String netTicketQuantity,
        String importTicketMoney,
        String returnTicketMoney,
        String ticketNetMoney,
        String additionalCostMoney,
        String payableMoney,
