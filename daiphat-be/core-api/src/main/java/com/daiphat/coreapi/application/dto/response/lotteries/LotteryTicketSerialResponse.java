...
public record LotteryTicketSerialResponse(
        ...
        @JsonView(Views.Admin.class) boolean manualOverride,
        @JsonView(Views.Admin.class) String overrideReason,
        @JsonView(Views.Admin.class) String overrideEvidenceUrl,
        @JsonView(Views.Admin.class) Long returnBatchLineId,
