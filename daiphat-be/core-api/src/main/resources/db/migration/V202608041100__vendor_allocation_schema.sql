...
CREATE TABLE IF NOT EXISTS allocation_batches (
    ...
    deposit_rate_snapshot NUMERIC(6,5), late_policy_snapshot VARCHAR(30), return_cutoff_snapshot TIME,
...
-- Skeleton: Daily_Sales_Report_Detail (detail_id no FK — Product vs Allocation detail TBD)
...
-- Skeleton: Agent_Settlement (settle logic still on allocation_batches in Phase 1)
