...
/**
 * General Business Validation Service.
 * Note: Currently handles both data uniqueness (Guards) and flow-specific business rules.
 * Consider splitting into specialized validators if responsibilities continue to grow.
 */
@Service
