...
public enum ErrorCode {
    ...
    PASSWORD_WEAK("AUTH_017", "Mật khẩu không đủ mạnh (Cần ít nhất 8 ký tự, bao gồm chữ hoa, chữ thường, số và ký tự đặc biệt).", HttpStatus.BAD_REQUEST),
    USERNAME_INVALID("AUTH_018", "Username không hợp lệ (3-20 ký tự, chỉ chấp nhận chữ cái, số và dấu gạch dưới).", HttpStatus.BAD_REQUEST),
    FIELD_TOO_LONG("AUTH_019", "Thông tin nhập vào quá dài (Tối đa 100 ký tự).", HttpStatus.BAD_REQUEST),
    USER_INACTIVE("AUTH_020", "Tài khoản chưa được kích hoạt. Vui lòng kiểm tra email để xác nhận.", HttpStatus.FORBIDDEN),
    USER_BANNED("AUTH_021", "Tài khoản bị khóa vĩnh viễn. Vui lòng liên hệ bộ phận CSKH để được hỗ trợ.", HttpStatus.FORBIDDEN),
    USER_LOCKED("AUTH_022", "Vui lòng thử lại sau %s giây.", HttpStatus.FORBIDDEN),
    EMAIL_NOT_VERIFIED("AUTH_023", "Email chưa được xác thực. Vui lòng kiểm tra hộp thư của bạn.", HttpStatus.FORBIDDEN),
    ...
    TOO_MANY_REQUESTS("SYS_003", "Bạn đã thực hiện quá nhiều yêu cầu, vui lòng thử lại sau %s giây.", HttpStatus.TOO_MANY_REQUESTS),
